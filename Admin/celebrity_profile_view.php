...
INNER JOIN `customer` ON `star_details`.`user_id`=`customer`.`user_id` WHERE `star_id`=:star_id";
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Profile for : <?php echo $row['first_name'] ?> <?php echo $row['mid_name'] ?> <?php echo $row['last_name'] ?></h4>
                    
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row['first_name'] ?> <?php echo $row['mid_name'] ?> <?php echo $row['last_name'] ?>" placeholder="Name" readonly />
                      </div>
					  
					   <div class="form-group">
                        <label for="exampleInputName1">Stage Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row['stage_aka'] ?> " placeholder="Name" readonly />
                      </div>
					   <div class="form-group">
                        <label for="exampleInputName1">Address</label>
                        <input type="text" class="form-control" id="exampleInputName1"  value="<?php echo $row['address2'] ?> <?php echo $row['address3'] ?> <?php echo $row['address1'] ?>"  placeholder="Name" readonly />
                      </div>
					   <div class="form-group">
                        <label for="exampleInputName1">Phone Numbers</label>
                        <input type="text" class="form-control" value="<?php echo $row['contact_1'] ?> <?php echo $row['business_line'] ?>" id="exampleInputName1" placeholder="Name"  readonly />
                      </div>
					   <div class="form-group">
                        <label for="exampleInputName1">Managers Contact</label>
                        <input type="text" class="form-control" value="<?php echo $row['managers_contact'] ?> " id="exampleInputName1" placeholder="Name" readonly />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail3" value="<?php echo $row['email'] ?>" placeholder="Email" readonly />
                      </div>
...
<?php } ?>	
                      ...
                      <a href=""><button class="btn btn-light">Back</button><a>
                    </form>
                  </div>
                </div>
              </div>
