                ...
                <div class="card">
                 ...
                 <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter User first name ,middle name or last name" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">From User</label>
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter User first name ,middle name or last name" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Date From</label>
                        <input type="date" class="form-control" id="exampleInputPassword4" placeholder="date from" />
                      </div>
					  <div class="form-group">
